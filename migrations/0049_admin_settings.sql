...
('branding', 'agency_address', '123 Main St, Salt Lake City, UT 84101', 'string', 'Agency Address', 'Physical address shown on reports and citations', NULL, 3),
('branding', 'agency_phone', '(801) 555-0100', 'string', 'Agency Phone', 'Main contact number displayed in headers', NULL, 4),
('branding', 'agency_email', 'info@rmpgutah.us', 'string', 'Agency Email', 'Public contact email', NULL, 5),
('branding', 'agency_website', 'https://rmpgutah.us', 'string', 'Agency Website', 'Official website URL', NULL, 6),
('branding', 'primary_color', '#000000', 'color', 'Primary Color', 'Main brand color for backgrounds and chrome', NULL, 7),
('branding', 'accent_color', '#d4a017', 'color', 'Accent Color', 'Gold accent used for highlights, borders, and active states', NULL, 8),
('branding', 'header_logo_url', '', 'string', 'Header Logo URL', 'Custom logo image URL (PNG/SVG). Leave empty for default.', NULL, 9),
...
('display', 'font_scale_default', '1.0', 'number', 'Default Font Scale', 'Base font size multiplier (0.8 to 1.5)', NULL, 4),
('display', 'compact_mode_default', 'false', 'boolean', 'Compact Mode Default', 'Enable compact data density by default', NULL, 5),
('display', 'show_grid_lines', 'true', 'boolean', 'Table Grid Lines', 'Show row separators in data tables', NULL, 6),
('display', 'show_row_numbers', 'false', 'boolean', 'Row Numbers', 'Show row number column in data tables', NULL, 7),
...
('display', 'timezone', 'America/Denver', 'string', 'Timezone', 'Default timezone for timestamps (IANA format)', NULL, 10),
...
('notifications', 'in_app_notifications_enabled', 'true', 'boolean', 'In-App Notifications', 'Show notifications in the notification center', NULL, 4),
('notifications', 'notify_dispatch_p1', 'true', 'boolean', 'P1 Dispatch Alerts', 'Notify on Priority 1 dispatch calls', NULL, 5),
('notifications', 'notify_dispatch_p2', 'true', 'boolean', 'P2 Dispatch Alerts', 'Notify on Priority 2 dispatch calls', NULL, 6),
('notifications', 'notify_bolo_issued', 'true', 'boolean', 'BOLO Issued', 'Notify when a BOLO is issued', NULL, 7),
('notifications', 'notify_warrant_hit', 'true', 'boolean', 'Warrant Hits', 'Notify on NCIC warrant confirmation', NULL, 8),
...
('security', 'password_require_special', 'false', 'boolean', 'Require Special Char', 'Passwords must contain at least one special character', NULL, 4),
('security', 'password_expiry_days', '90', 'number', 'Password Expiry', 'Days before password must be changed (0 = never)', NULL, 5),
('security', 'max_login_attempts', '5', 'number', 'Max Login Attempts', 'Failed attempts before account lockout', NULL, 6),
('security', 'lockout_duration_minutes', '30', 'number', 'Lockout Duration', 'Minutes an account stays locked after max attempts', NULL, 7),
('security', 'session_timeout_minutes', '480', 'number', 'Session Timeout', 'Minutes of inactivity before auto-logout (0 = never)', NULL, 8),
...
('records', 'person_merge_threshold', '0.85', 'number', 'Merge Confidence', 'Minimum confidence score to suggest person record merges (0-1)', NULL, 4),
('records', 'require_warrant_check', 'true', 'boolean', 'Require Warrant Check', 'Always run warrant check when creating a person record', NULL, 5),
('records', 'require_address_validation', 'false', 'boolean', 'Require Address Validation', 'Validate addresses before saving records', NULL, 6),
...
('maps', 'default_center_lng', '-111.8910', 'number', 'Default Center Lng', 'Default map center longitude', NULL, 4),
('maps', 'show_map_labels', 'true', 'boolean', 'Show Map Labels', 'Display street/location labels on maps', NULL, 5),
('maps', 'gps_update_interval', '5', 'number', 'GPS Update Interval', 'Seconds between GPS position updates from units', NULL, 6),
...
('reports', 'include_bates_numbering', 'true', 'boolean', 'Bates Numbering', 'Add Bates numbers to multi-page reports', NULL, 4),
('reports', 'include_form_number', 'true', 'boolean', 'Form Number Footer', 'Show form revision number in report footers', NULL, 5),
('reports', 'include_barcode', 'false', 'boolean', 'Include Barcode', 'Add scannable barcode to report footers', NULL, 6),
...
('audit', 'audit_record_edits', 'true', 'boolean', 'Log Record Edits', 'Log all record modifications', NULL, 4),
...
('system', 'max_upload_size_mb', '50', 'number', 'Max Upload Size', 'Maximum file upload size in megabytes', NULL, 4),
('system', 'backup_schedule', '', 'select', 'Backup Schedule', 'Database backup frequency', '["daily","weekly","monthly","none"]', 5),
('system', 'backup_retention_count', '7', 'number', 'Backup Retention', 'Number of backups to retain', NULL, 6),
('system', 'error_reporting_enabled', 'true', 'boolean', 'Error Reporting', 'Send client-side errors to monitoring', NULL, 7),
('system', 'version_check_enabled', 'true', 'boolean', 'Version Check', 'Automatically check for new versions', NULL, 8),
('system', 'announcement_banner_text', '', 'string', 'Announcement Banner', 'System-wide announcement shown at top of all pages', NULL, 9),
