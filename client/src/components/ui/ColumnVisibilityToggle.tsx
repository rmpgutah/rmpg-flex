...
export default function ColumnVisibilityToggle({ columns, onChange, className = '' }: ColumnVisibilityToggleProps) {
  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-50 min-w-[180px] bg-surface-base border border-border-default shadow-xl py-1">
          <div className="px-3 py-1.5 border-b border-rmpg-700 flex items-center justify-between">
