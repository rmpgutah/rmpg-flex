          ...
          >
            <button
              ...
              style={{
                ...
                color: mobileTab === 'left' ? '#fff' : '#6b7f96',
            ...
            <button
              ...
              style={{
                ...
                color: mobileTab === 'right' ? '#fff' : '#6b7f96',
      ...
      {rightVisible && (
        <div
          ...
          style={{
            ...
            background: isDragging ? '#1a5a9e' : 'linear-gradient(90deg, #1e3048, #2a3e58, #1e3048)',
          ...
          onMouseLeave={(e) => {
            if (!isDragging) (e.currentTarget as HTMLElement).style.background = 'linear-gradient(90deg, #1e3048, #2a3e58, #1e3048)';
          }}
        />
      )}
