...
export default function SuggestedLinksPanel() {
  ...
  return (
    <div className="bg-surface-base border border-accent-gold-300">
      <div className="px-2 py-[3px] text-[9px] font-semibold text-[color:var(--field-label-color)] border-b border-border-default">
