...
const METRIC_CONFIG: { key: keyof ScorecardData['metrics']; label: string; icon: React.ElementType; color: string }[] = [
  { key: 'response_time', label: 'Response Time', icon: Activity, color: '#3b82f6' },
...
export default function ShiftScorecard({ officerId }: ShiftScorecardProps) {
  ...
  const conicGradient = data
    ? `conic-gradient(${GRADE_COLORS[data.grade] || '#888888'} ${pct * 3.6}deg, #0a0a0a 0deg)`
    : 'conic-gradient(#0a0a0a 360deg)';

  const trend = data ? TREND_ICONS[data.trend.direction] : null;

  return (
    <div className="panel-beveled" style={{ background: '#141414' }}>
      <PanelTitleBar title="Shift Scorecard" icon={Award}>
        <input
          ...
          style={{ fontFamily: 'monospace', background: '#0a0a0a', color: '#94a3b8', border: '1px solid #888888', borderRadius: 2, padding: '1px 6px' }}
        />
      </PanelTitleBar>
        ...
        <div className="p-3 space-y-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative flex items-center justify-center" style={{ width: 72, height: 72 }}>
              ...
              <div
                ...
                style={{
                  ...
                  background: '#141414', fontFamily: 'monospace', fontSize: 18,
            ...
            <div className="flex-1 space-y-1">
              ...
              {/* Peer rank bar */}
              <div style={{ height: 4, background: '#0a0a0a', borderRadius: 2, position: 'relative' }}>
                <div
                  style={{
            ...
            {METRIC_CONFIG.map(({ key, label, icon: MIcon, color }) => {
              ...
              return (
                <div key={key} className="flex items-center gap-2">
                  ...
                  <div className="flex-1" style={{ height: 8, background: '#0a0a0a', borderRadius: 2, position: 'relative' }}>
                    <div
                      style={{
                        position: 'absolute', top: 0, left: 0, height: '100%', borderRadius: 2,
