      ...
      <div className="flex items-center gap-2 flex-wrap px-3 py-2 bg-surface-base border-b border-rmpg-700">
        <div className="relative flex-1 min-w-[200px] max-w-xs">
          ...
          <input
            ...
            className="w-full bg-surface-sunken border border-rmpg-700 text-white text-sm pl-7 pr-2 py-1.5 rounded-sm focus:border-brand-500 focus:outline-none"
          />
        </div>
        <select
          value={filterSource}
          onChange={e => setFilterSource(e.target.value)}
          className="bg-surface-sunken border border-rmpg-700 text-white text-xs px-2 py-1.5 rounded-sm focus:border-brand-500 focus:outline-none"
        >
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-surface-sunken border border-rmpg-700 text-white text-xs px-2 py-1.5 rounded-sm focus:border-brand-500 focus:outline-none"
                >
                  {PIPELINE_STAGES.map(s => (
                    <option key={s} value={s}>{toDisplayLabel(s)}</option>
                  ))}
              ...
              <div className="panel-beveled p-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-surface-sunken border border-rmpg-700 text-white text-xs px-2 py-1.5 rounded-sm focus:border-brand-500 focus:outline-none resize-none"
                />
              ...
              <div className="panel-beveled p-2">
                ...
                <input
                  ...
                  className="w-full bg-surface-sunken border border-rmpg-700 text-white text-xs px-2 py-1 rounded-sm focus:border-brand-500 focus:outline-none mb-1"
                />
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-surface-sunken border border-rmpg-700 text-white text-xs px-2 py-1 rounded-sm focus:border-brand-500 focus:outline-none resize-none"
                />
                <div className="flex justify-end mt-1">
                  <button
            ...
            <form onSubmit={handleCreateLead} className="p-3 space-y-2">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-surface-sunken border border-rmpg-700 text-white text-sm px-2 py-1.5 rounded-sm focus:border-brand-500 focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-surface-sunken border border-rmpg-700 text-white text-sm px-2 py-1.5 rounded-sm focus:border-brand-500 focus:outline-none resize-none"
                />
              </div>
