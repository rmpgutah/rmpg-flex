...
export default function ScraperAdminPanel({ onClose }: ScraperAdminPanelProps) {
  ...
  if (loading) {
    return (
      <div className="px-3 py-4 bg-[#0c0f13] border-b border-rmpg-700 flex items-center justify-center">
  ...
  return (
    <div className="bg-[#0c0f13] border-b border-rmpg-700 max-h-[350px] overflow-y-auto">
      {/* Header */}
          ...
          <tbody>
            {sources.map(src => (
              <React.Fragment key={src.id}>
                <tr className="border-b border-rmpg-700/30 hover:bg-[#161b21]">
