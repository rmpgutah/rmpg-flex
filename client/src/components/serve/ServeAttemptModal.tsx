...
>>>>>>> main
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-[#0c0f13] border border-[#2b313a] rounded-[2px] p-2">
...
<<<<<<< HEAD
                          : 'border-[#2b313a] bg-[#0c0f13] hover:border-[#d4a017] hover:bg-[#161b21]'
=======
...
>>>>>>> main
            ...
            <div className="flex justify-between pt-2">
              <button type="button"
                onClick={() => setStep(0)}
                className="px-4 py-2 text-sm font-semibold bg-[#1b2128] hover:bg-[#1e2d3f] text-rmpg-200 rounded-[2px] border border-[#2b313a] transition-all duration-150 focus:outline-none focus:ring-1 focus:ring-[#888888]/50"
              >
                Back
              </button>
              <button type="button"
        ...
        return (
          <div className="space-y-4 p-4 max-h-[60vh] overflow-y-auto scrollbar-dark">
            ...
            {(attemptType === 'personal' || attemptType === 'substitute') && (
              <fieldset className="space-y-3 border border-[#2b313a] rounded-[2px] p-3">
...
>>>>>>> main
          ...
          <div className="space-y-4 p-4 max-h-[60vh] overflow-y-auto scrollbar-dark">
            {submitResult ? (
              ...
              <>
                ...
                {/* Summary card */}
                <div className="bg-[#0c0f13] border border-[#2b313a] rounded-[2px] p-3 space-y-2 text-sm">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200" role="dialog" aria-modal="true" aria-label="Document Service Attempt">
      <div className="bg-[#161b21] panel-beveled rounded-[2px] w-full max-w-lg mx-4 max-h-[90vh] flex flex-col shadow-md animate-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-[#2b313a] bg-[#0c0f13]">
          <h2 className="text-sm font-bold text-rmpg-100 tracking-wide">
            Document Service Attempt — {job.recipient_name}
          </h2>
          <button type="button"
            onClick={onClose}
            className="text-rmpg-400 hover:text-rmpg-200 transition-colors p-1 rounded-[2px] hover:bg-[#1b2128] focus:outline-none focus:ring-1 focus:ring-[#888888]/50"
