        ...
        <div className="p-3 space-y-3">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <button type="button" disabled={!!busy} onClick={() => submit('save')}
              className="flex items-center justify-center gap-1 text-[11px] font-bold uppercase py-2 px-3 border border-[#d4a017] text-[#d4a017] hover:bg-[#1a1400] disabled:opacity-40">
