...
const TOOLBAR_NAV: NavItem[] = [
  ...
  { path: '/records', icon: Database, label: 'Records', group: 'records', shortcut: 'F6', children: [
    ...
    { path: '/arrest-records', icon: Shield, label: 'Arrest Records' },
    { path: '/dl-search', icon: CreditCard, label: 'DL Search' },
    { path: '/skiptracer-v2', icon: Search, label: 'Skip Tracer' },
    ...
    { path: '/digital-forensics', icon: ExternalLink, label: 'Digital Forensics' },
  ...
  { path: '/warrants', icon: AlertTriangle, label: 'Enforce', group: 'records', shortcut: 'F7', children: [
    ...
    { path: '/sex-offender-registry', icon: UserX, label: 'Sex Offender Registry' },
    { path: '/colorado-doc', icon: Database, label: 'Colorado DOC Search' },
