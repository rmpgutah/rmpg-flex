    ...
    items: [
      ...
      { type: 'separator' },
      {
        ...
        items: [
          ...
          { type: 'action', label: 'Law Books & Statutes', icon: Scale, action: () => { setShowLawBooks(true); } },
      ...
      },
      {
        ...
        icon: GraduationCap,
        items: [
          { type: 'action', label: 'Policies & SOPs', icon: BookOpen, action: () => navigate('/training-docs') },
          { type: 'action', label: 'Training Dashboard', icon: GraduationCap, action: () => navigate('/training') },
          { type: 'action', label: 'Daily Activity Reports', icon: CalendarDays, action: () => navigate('/dar') },
          { type: 'action', label: 'Audit Log', icon: ScrollText, action: () => navigate('/audit') },
        ],
      },
      {
