 ...
 *
 * Mirrors src/utils/formatServiceAddress.ts. Keep the two in lockstep:
 * the worker formats the string the client PDF prints, and the client
 * formats the same string on the signing page.
 */
