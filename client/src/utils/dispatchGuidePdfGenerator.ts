...
function buildSectionSpecs(): SectionSpec[] {
  return [
    ...
    { label: '15. Field Interviews',                       emit: section16 },
    { label: '16. Process Service / Serve Queue',          emit: section17 },
    { label: '17. Skip Tracer V2',                         emit: section18 },
    { label: '18. Compound & Universal Search',            emit: section19 },
    { label: '19. Anatomy of the Console',                 emit: section20 },
    { label: '20. Worked Example — Shots-Fired Call',      emit: section21 },
    { label: '21. Your First Shift — Onboarding',          emit: section22 },
    { label: '22. How To Use — AI & Subsystems',           emit: section23 },
