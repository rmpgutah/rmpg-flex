    ...
    <div className="app-grid-bg h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          {/* Footer */}
          {results.length > 0 && (
            <div className="mx-2 mb-2 px-2.5 py-1 bg-[#141e2b] border border-[#1e3048] rounded-sm flex items-center justify-between text-[9px] text-rmpg-500">
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    {parseOffenses(selected.offenses).map((offense, i) => (
                      <div
                        key={i}
                        className="px-2 py-1 bg-[#0d1520] border border-[#1e3048] rounded-sm text-[10px] text-rmpg-300 flex items-start gap-1.5"
                      >
