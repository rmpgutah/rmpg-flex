...
export default function IntelComingSoon({ title, phase }: { title: string; phase: string }) {
  return (
    <div className="p-6">
      <div className="max-w-md border border-border-subtle border-l-[3px] border-l-[color:var(--panel-header-color)] bg-surface-overlay rounded-[2px] p-4">
        <div className="font-mono text-[9px] tracking-widest text-[color:var(--panel-header-color)] uppercase">{phase}</div>
        <div className="text-[15px] text-rmpg-100 mt-1">{title}</div>
