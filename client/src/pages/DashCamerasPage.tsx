...
import {
  Car, Video, Upload, Search, Loader2, Trash2, Edit2,
...
export default function DashCamerasPage() {
  ...
  // Filtered list (client-side classification filter)
  const filtered = useMemo(() => {
    if (classFilter === 'all') return videos;
    return videos.filter(v => v.classification === classFilter);
  }, [videos, classFilter]);
