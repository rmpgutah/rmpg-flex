          ...
          <div className="bg-surface-raised border border-rmpg-700 p-6 max-w-lg w-full" style={{ borderRadius: 2 }} onClick={e => e.stopPropagation()}>
            ...
            {tab === 'callouts' ? (
              <div className="grid grid-cols-2 gap-3">
                <div><label htmlFor="ff-specialopspage-0" className="text-[9px] text-rmpg-400 uppercase font-bold">Date</label><input id="ff-specialopspage-0" type="datetime-local" value={formData.date} onChange={e => setFormData({...formData, date: e.target.value})} className="input-dark w-full mt-1 text-xs" /></div>
                <div><label htmlFor="ff-specialopspage-1" className="text-[9px] text-rmpg-400 uppercase font-bold">Type *</label><input id="ff-specialopspage-1" value={formData.call_type} onChange={e => setFormData({...formData, call_type: e.target.value})} className="input-dark w-full mt-1 text-xs" placeholder="e.g. SWAT, K9, EOD" /></div>
                <div><label htmlFor="ff-specialopspage-2" className="text-[9px] text-rmpg-400 uppercase font-bold">Location</label><input id="ff-specialopspage-2" value={formData.location} onChange={e => setFormData({...formData, location: e.target.value})} className="input-dark w-full mt-1 text-xs" /></div>
                <div><label htmlFor="ff-specialopspage-3" className="text-[9px] text-rmpg-400 uppercase font-bold">Resolution</label><input id="ff-specialopspage-3" value={formData.resolution} onChange={e => setFormData({...formData, resolution: e.target.value})} className="input-dark w-full mt-1 text-xs" /></div>
                <div><label htmlFor="ff-specialopspage-4" className="text-[9px] text-rmpg-400 uppercase font-bold">Duration (min)</label><input id="ff-specialopspage-4" type="number" value={formData.duration_minutes} onChange={e => setFormData({...formData, duration_minutes: parseInt(e.target.value) || 0})} className="input-dark w-full mt-1 text-xs" /></div>
                <div><label htmlFor="ff-specialopspage-5" className="text-[9px] text-rmpg-400 uppercase font-bold">Team Size</label><input id="ff-specialopspage-5" type="number" value={formData.team_size} onChange={e => setFormData({...formData, team_size: parseInt(e.target.value) || 0})} className="input-dark w-full mt-1 text-xs" /></div>
              </div>
            ) : (
              <div className="grid grid-cols-2 gap-3">
                <div><label htmlFor="ff-specialopspage-6" className="text-[9px] text-rmpg-400 uppercase font-bold">Type *</label><input id="ff-specialopspage-6" value={formData.equipment_type} onChange={e => setFormData({...formData, equipment_type: e.target.value})} className="input-dark w-full mt-1 text-xs" /></div>
                <div><label htmlFor="ff-specialopspage-7" className="text-[9px] text-rmpg-400 uppercase font-bold">Serial #</label><input id="ff-specialopspage-7" value={formData.serial_number} onChange={e => setFormData({...formData, serial_number: e.target.value})} className="input-dark w-full mt-1 text-xs" /></div>
                <div><label htmlFor="ff-specialopspage-8" className="text-[9px] text-rmpg-400 uppercase font-bold">Condition</label><select id="ff-specialopspage-8" value={formData.condition} onChange={e => setFormData({...formData, condition: e.target.value})} className="input-dark w-full mt-1 text-xs"><option value="ready">Ready</option><option value="repair">Repair</option><option value="retired">Retired</option><option value="lost">Lost</option></select></div>
                <div><label htmlFor="ff-specialopspage-9" className="text-[9px] text-rmpg-400 uppercase font-bold">Assigned To</label><input id="ff-specialopspage-9" value={formData.assigned_to} onChange={e => setFormData({...formData, assigned_to: e.target.value})} className="input-dark w-full mt-1 text-xs" /></div>
              </div>
            )}
            <div className="mt-3"><label htmlFor="ff-specialopspage-10" className="text-[9px] text-rmpg-400 uppercase font-bold">Notes</label><textarea id="ff-specialopspage-10" value={formData.notes || ''} onChange={e => setFormData({...formData, notes: e.target.value})} className="input-dark w-full mt-1 text-xs" rows={3} /></div>
