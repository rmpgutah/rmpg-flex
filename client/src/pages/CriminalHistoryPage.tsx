...
export default function CriminalHistoryPage() {
  ...
  return (
    <div className="h-full flex flex-col bg-surface-base text-white overflow-hidden">
      <PanelTitleBar title="Criminal History" icon={Shield}>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Person Results List */}
        <div className="w-1/3 border-r border-rmpg-700/50 overflow-auto">
              ...
              <div className="panel-surface p-4">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-4 mt-1 text-[10px] text-rmpg-300">
