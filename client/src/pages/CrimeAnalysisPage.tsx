  ...
  const OrangeGradient = (
    <defs>
      <linearGradient id="orangeBar" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0%" stopColor="var(--amber-900)" />
              ...
              {todData.length === 0 ? (
                ...
                <>
                    ...
                    <AreaChart data={todData} margin={{ left: 0, right: 4, top: 8, bottom: 0 }}>
                      <defs>
                        <linearGradient id="todGrad" x1="0" y1="0" x2="0" y2="1">
                          <stop offset="0%" stopColor="var(--purple-600)" stopOpacity={0.5} />
                      ...
                      <Area type="monotone" dataKey="count" stroke="var(--purple-600)" strokeWidth={2}
                        fill="url(#todGrad)" dot={false} activeDot={{ r: 3, fill: 'var(--purple-400)', stroke: 'var(--purple-600)' }} />
                    </AreaChart>
                  </ResponsiveContainer>
                  <div className="flex items-center justify-center gap-4 mt-2">
                    ...
                    <span className="flex items-center gap-1 text-[9px] text-rmpg-400">
                      <div className="w-3 h-2" style={{ background: 'var(--purple-600)' }} /> Night
                    </span>
                  </div>
                </>
              )}
          ...
          <div className="panel-surface">
            ...
            <div className="p-3">
                  ...
                  <BarChart data={dowData} margin={{ left: 0, right: 4, top: 8, bottom: 0 }}>
                    <defs>
                      ...
                      <linearGradient id="purpleBar" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="var(--purple-400)" />
              ...
              <div className="flex items-center justify-center gap-4 mt-1">
                ...
                <span className="flex items-center gap-1 text-[9px] text-rmpg-400">
                  <div className="w-3 h-2 rounded-[1px]" style={{ background: 'var(--purple-400)' }} /> Weekend
                </span>
              </div>
            </div>
          </div>
