...
export default function MapLegend({ layers, showBreadcrumbs, breadcrumbColorMode }: MapLegendProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between px-2.5 py-1.5" style={{ borderBottom: '1px solid #2b313a' }}>
      ...
      <div className="px-2.5 py-2 space-y-2.5">
        ...
        <div>
          ...
          <div className="space-y-0.5">
            {STATUS_ORDER.map((status) => (
              <div key={status} className="flex items-center gap-1.5 hover:bg-[#1b2128]/50 transition-colors duration-100 px-0.5 -mx-0.5 rounded-sm">
        ...
        {/* Call Priority */}
        <div>
          <div className="h-px mb-2" style={{ background: 'linear-gradient(90deg, transparent, #2b313a, transparent)' }} />
          <div className="text-[8px] font-mono font-bold tracking-wider text-[#9ca3af] uppercase mb-1">Call Priority</div>
          <div className="space-y-0.5">
            {PRIORITY_ORDER.map((p) => (
              <div key={p} className="flex items-center gap-1.5 hover:bg-[#1b2128]/50 transition-colors duration-100 px-0.5 -mx-0.5 rounded-sm">
        ...
        <div>
          ...
          <div className="space-y-0.5">
            {layers.properties && (
              <div className="flex items-center gap-1.5 hover:bg-[#1b2128]/50 transition-colors duration-100 px-0.5 -mx-0.5 rounded-sm">
