  ...
  return (
    <div className="panel-beveled bg-surface-base overflow-hidden transition-all duration-200 ease-out shadow-lg backdrop-blur-sm" style={{ width: 300 }}>
      ...
      >
        ...
        {onClose && (
          <button type="button" onClick={onClose} className="toolbar-btn p-1 hover:bg-[#1b2128] transition-colors duration-150 rounded-sm" title="Close" aria-label="Close predictions panel">
      ...
      <div className="p-2 space-y-2">
        ...
        {!loading && hotspots.length > 0 && (
          <>
            ...
            {/* ── Hotspot list ────────────────────────────── */}
            <div className="max-h-[360px] space-y-1.5 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-[#2b313a] scrollbar-track-transparent" style={{ scrollbarWidth: 'thin' }}>
              {hotspots.map((hs, idx) => {
