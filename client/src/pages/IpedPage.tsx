    ...
    <div className="app-grid-bg h-full flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-[#2b313a]">
        ...
        <div className="flex items-center gap-2">
          <button type="button"
            ...
            className="p-1.5 rounded-sm hover:bg-[#1b2128] text-rmpg-400 hover:text-white transition-colors"
            title="Refresh all"
          >
            <RefreshCw size={14} />
          </button>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="p-3 space-y-2">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-2 py-1.5 text-xs bg-[#0c0f13] border border-[#2b313a] text-white placeholder-rmpg-500 font-mono outline-none"
              />
          ...
          <div className="p-3">
            {hashSetsLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                {hashSets.map((hs) => (
                  <div key={hs.name} className="flex items-center justify-between px-3 py-2 rounded-sm bg-[#0c0f13] border border-[#2b313a] group">
        ...
        <div className="card-glass rounded-sm flex-1 flex flex-col min-h-0">
          <div className="flex items-center justify-between px-3 py-2 border-b border-[#2b313a]">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="text-[10px] bg-[#0c0f13] border border-[#2b313a] text-rmpg-300 rounded-sm px-2 py-1 focus:outline-none focus:border-brand-blue/50"
              >
          ...
          <div className="flex-1 overflow-auto">
            {jobsLoading ? (
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="text-[10px] text-rmpg-500 uppercase tracking-wider border-b border-[#2b313a]">
                  ...
                  {jobs.map((job) => {
                    ...
                    return (
                      <tr
                        ...
                        className={`border-b border-[#2b313a]/50 cursor-pointer transition-colors hover:bg-[#1b2128]/60 ${selectedJob?.id === job.id ? 'bg-brand-blue/10' : ''}`}
                      >
                        ...
                        <td className="px-3 py-2 hidden lg:table-cell">
                          {job.status === 'running' && job.progress_percent != null ? (
                            <div className="flex items-center gap-2">
                              <div className="w-16 h-1.5 bg-[#0c0f13] rounded-full overflow-hidden">
                                <div
                        ...
                        <td className="px-3 py-2 text-right">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <button type="button"
                              ...
                              className="p-1 rounded-sm text-rmpg-400 hover:text-white hover:bg-[#1b2128] transition-colors"
                              title="View details"
                            >
                              <Eye size={12} />
                            </button>
          ...
          {/* Pagination */}
          {totalPages > 1 && (
            <div className="flex items-center justify-between px-3 py-2 border-t border-[#2b313a]">
              ...
              <div className="flex items-center gap-1">
                <button type="button"
                  ...
                  className="px-2 py-1 text-[10px] rounded-sm bg-[#0c0f13] border border-[#2b313a] text-rmpg-400 hover:text-white disabled:opacity-40 transition-colors"
                >
                  Prev
                </button>
                <button type="button"
          ...
          <div className="card-glass rounded-sm">
            <div className="flex items-center justify-between px-3 py-2 border-b border-[#2b313a]">
              ...
              <button type="button"
                ...
                className="p-1 rounded-sm text-rmpg-500 hover:text-white hover:bg-[#1b2128] transition-colors"
              >
                <X size={14} />
              </button>
            </div>
                ...
                <>
                  ...
                  <div className="text-xs space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <code className="text-rmpg-400 bg-[#0c0f13] px-2 py-0.5 rounded-sm text-[10px] font-mono truncate flex-1">
                  ...
                  {selectedJob.status === 'running' && selectedJob.progress_percent != null && (
                    <div className="space-y-1">
                      ...
                      <div className="w-full h-2 bg-[#0c0f13] rounded-full overflow-hidden">
                        <div
                  ...
                  {selectedJob.result_summary && (
                    <div className="bg-[#0c0f13] border border-[#2b313a] rounded-sm px-3 py-2">
                  ...
                  {jobHashes.length > 0 && (
                    <div>
                      ...
                      <div className="overflow-auto max-h-48 border border-[#2b313a] rounded-sm">
                        <table className="w-full text-[10px]">
                          <thead>
                            <tr className="text-rmpg-500 uppercase border-b border-[#2b313a] bg-[#0c0f13]">
                          ...
                          <tbody>
                            {jobHashes.map((h) => (
                              <tr key={h.id} className="border-b border-[#2b313a]/30">
        ...
        <div className="fixed inset-0 z-50 print:hidden flex items-center justify-center bg-black/60" role="dialog" aria-modal="true" onClick={() => setShowNewJob(false)}>
          <div className="card-glass rounded-sm w-full max-w-md mx-4 shadow-md" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between px-4 py-3 border-b border-[#2b313a]">
              ...
              <button type="button" onClick={() => setShowNewJob(false)} className="p-1 rounded-sm text-rmpg-500 hover:text-white hover:bg-[#1b2128] transition-colors">
                <X size={14} />
              </button>
            </div>
            <div className="p-4 space-y-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full text-xs bg-[#0c0f13] border border-[#2b313a] text-rmpg-300 rounded-sm px-3 py-2 focus:outline-none focus:border-brand-blue/50"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs bg-[#0c0f13] border border-[#2b313a] text-rmpg-300 rounded-sm px-3 py-2 focus:outline-none focus:border-brand-blue/50 font-mono placeholder-slate-600"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 42"
                  className="w-full text-xs bg-[#0c0f13] border border-[#2b313a] text-rmpg-300 rounded-sm px-3 py-2 focus:outline-none focus:border-brand-blue/50 placeholder-slate-600"
                />
              </div>
            ...
            <div className="flex items-center justify-end gap-2 px-4 py-3 border-t border-[#2b313a]">
              <button type="button"
                onClick={() => setShowNewJob(false)}
                className="px-3 py-1.5 text-xs rounded-sm bg-[#1b2128] text-rmpg-400 hover:text-white border border-[#2b313a] transition-colors"
              >
                Cancel
              </button>
              <button type="button"
        ...
        <div className="fixed inset-0 z-50 print:hidden flex items-center justify-center bg-black/60" role="dialog" aria-modal="true" onClick={() => setShowImportHashSet(false)}>
          <div className="card-glass rounded-sm w-full max-w-md mx-4 shadow-md" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between px-4 py-3 border-b border-[#2b313a]">
              ...
              <button type="button" onClick={() => setShowImportHashSet(false)} className="p-1 rounded-sm text-rmpg-500 hover:text-white hover:bg-[#1b2128] transition-colors">
                <X size={14} />
              </button>
            </div>
            <div className="p-4 space-y-3">
...
function StatCard({ label, value, icon: Icon, color, pulse }: {
  ...
  return (
    <div className="card-glass rounded-sm px-3 py-2.5 flex items-center gap-3">
      <div className={`p-1.5 rounded-sm bg-[#0c0f13] ${color}`}>
