  ...
  useEffect(() => {
    ...
    const unsubDispatch = subscribe('dispatch_update', (msg: any) => {
      ...
      if (data.action === 'call_created' && data.call) {
        ...
        // Voice-synthesized safety alerts for new calls
                  ...
                  <div className="border-t border-rmpg-600 pt-3 mb-3">
                    ...
                    {isEditing ? (
                      <div className="grid grid-cols-7 gap-2 mt-1">
                        ...
                        <div><label className="text-[9px] text-brand-gold-500">Section ID</label><input type="text" className="input-dark text-xs" value={editData.section_id} onChange={(e) => updateEditField('section_id', e.target.value)} /></div>
                        <div><label className="text-[9px] text-brand-gold-500">Zone ID</label><input type="text" className="input-dark text-xs" value={editData.zone_id} onChange={(e) => updateEditField('zone_id', e.target.value)} /></div>
                        <div><label className="text-[9px] text-brand-gold-500">Beat ID</label><input type="text" className="input-dark text-xs" value={editData.beat_id} onChange={(e) => updateEditField('beat_id', e.target.value)} /></div>
                      </div>
                    ) : (
                      <div className="flex flex-wrap gap-x-6 gap-y-1 mt-1 text-xs">
                    ...
                    {isEditing ? (
                      <div className="space-y-2 mt-1">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                          ...
                          <div><label className="text-[9px] text-brand-gold-500">Weapons</label><input type="text" className="input-dark text-xs" value={editData.weapons_involved} onChange={(e) => updateEditField('weapons_involved', e.target.value)} /></div>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          <div><label className="text-[9px] text-brand-gold-500">Subject Description</label><input type="text" className="input-dark text-xs" value={editData.subject_description} onChange={(e) => updateEditField('subject_description', e.target.value)} /></div>
                          <div><label className="text-[9px] text-brand-gold-500">Vehicle Description</label><input type="text" className="input-dark text-xs" value={editData.vehicle_description} onChange={(e) => updateEditField('vehicle_description', e.target.value)} /></div>
                        </div>
                        <div><label className="text-[9px] text-brand-gold-500">Direction of Travel</label><input type="text" className="input-dark text-xs" value={editData.direction_of_travel} onChange={(e) => updateEditField('direction_of_travel', e.target.value)} /></div>
                ...
                {(isEditing || selectedCall.scene_safety || selectedCall.weather_conditions || selectedCall.lighting_conditions || selectedCall.alcohol_involved || selectedCall.drugs_involved || selectedCall.domestic_violence || selectedCall.le_notified || selectedCall.damage_estimate || selectedCall.action_taken) && (
                  <div className="border-t border-rmpg-600 pt-3 mb-3">
                    ...
                    {isEditing ? (
                      <div className="space-y-2 mt-1">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                          <div><label className="text-[9px] text-brand-gold-500">Scene Safety</label><input type="text" className="input-dark text-xs" placeholder="Secure, hazardous..." value={editData.scene_safety} onChange={(e) => updateEditField('scene_safety', e.target.value)} /></div>
                          <div><label className="text-[9px] text-brand-gold-500">Weather</label><input type="text" className="input-dark text-xs" placeholder="Clear, rain, snow..." value={editData.weather_conditions} onChange={(e) => updateEditField('weather_conditions', e.target.value)} /></div>
                          <div><label className="text-[9px] text-brand-gold-500">Lighting</label><input type="text" className="input-dark text-xs" placeholder="Daylight, dark, lit..." value={editData.lighting_conditions} onChange={(e) => updateEditField('lighting_conditions', e.target.value)} /></div>
                        </div>
                        ...
                        {editData.le_notified && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <div><label className="text-[9px] text-brand-gold-500">LE Agency</label><input type="text" className="input-dark text-xs" value={editData.le_agency} onChange={(e) => updateEditField('le_agency', e.target.value)} /></div>
                        ...
                        <div><label className="text-[9px] text-brand-gold-500">Responding Officer</label><input type="text" className="input-dark text-xs" value={editData.responding_officer} onChange={(e) => updateEditField('responding_officer', e.target.value)} /></div>
                      </div>
                    ) : (
                      <div className="flex flex-wrap gap-x-6 gap-y-1 mt-1 text-xs">
