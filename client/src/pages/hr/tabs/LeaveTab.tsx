...
function BalanceCard({
  ...
  return (
    <div className="bg-[#161b21] border border-[#2b313a] rounded-sm p-4 transition-all duration-200 hover:border-[#414852] hover:brightness-105" role="group" aria-label={`${label} leave balance`}>
      ...
      <div className="h-2 bg-[#0c0f13] rounded-full overflow-hidden mt-2" role="progressbar" aria-valuenow={pct} aria-valuemin={0} aria-valuemax={100} aria-label={`${label}: ${pct}% used, ${remaining} hours remaining`}>
        <div
  ...
  if (!isManager) {
    return (
      <div className="p-4 space-y-4">
        ...
        <div className="bg-[#161b21] border border-[#2b313a] rounded-sm overflow-x-auto scrollbar-dark">
          <table className="w-full text-xs" role="table" aria-label="Leave requests">
            <thead>
              <tr className="border-b border-[#2b313a] bg-[#0c0f13]">
            ...
            <tbody>
              {requests.length === 0 ? (
                ...
                requests.map((req, i) => (
                  <tr
                    key={req.id}
                    className={`border-b border-[#2b313a] transition-colors duration-150 hover:brightness-110 ${i % 2 === 0 ? 'bg-[#161b21]' : 'bg-[#14181d]'}`}
                  >
    ...
    <div className="p-4 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            {pendingRequests.map(req => (
              <div
                key={req.id}
                className="bg-[#161b21] border border-[#2b313a] rounded-sm p-4 space-y-3"
              >
                ...
                {req.reason && (
                  <p className="text-xs text-rmpg-300 bg-[#0c0f13] border border-[#2b313a] rounded-sm p-2">
                    {req.reason}
                  </p>
                )}
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 bg-[#0c0f13] border border-[#2b313a] text-white text-xs px-2 py-1.5 rounded-sm focus:outline-none focus:border-brand-500"
                  />
                  <button type="button"
      ...
      {balances.length > 0 && (
        <div className="space-y-2">
          ...
          <div className="bg-[#161b21] border border-[#2b313a] rounded-sm overflow-x-auto">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <select
            ...
            className="bg-[#0c0f13] border border-[#2b313a] text-white text-xs px-2 py-1.5 rounded-sm focus:outline-none focus:border-brand-500"
          >
...
function BalanceCell({ used, total, color }: { used: number; total: number; color: string }) {
  ...
  return (
    <div className="min-w-[100px]">
      ...
      <div className="h-1.5 bg-[#0c0f13] rounded-full overflow-hidden">
        <div
