...
function BalanceCard({
  ...
  return (
    <div className="bg-[#0a0a0a] border border-[#222222] rounded-sm p-4 transition-all duration-200 hover:border-[#2a3f5a] hover:brightness-105" role="group" aria-label={`${label} leave balance`}>
      ...
      <div className="h-2 bg-[#050505] rounded-full overflow-hidden mt-2" role="progressbar" aria-valuenow={pct} aria-valuemin={0} aria-valuemax={100} aria-label={`${label}: ${pct}% used, ${remaining} hours remaining`}>
        <div
  ...
  if (!isManager) {
    return (
      <div className="p-4 space-y-4">
        ...
        <div className="bg-[#0a0a0a] border border-[#222222] rounded-sm overflow-x-auto scrollbar-dark">
            ...
            <tbody>
              {requests.length === 0 ? (
                ...
                requests.map((req, i) => (
                  <tr
                    key={req.id}
                    className={`border-b border-[#222222] transition-colors duration-150 hover:brightness-110 ${i % 2 === 0 ? 'bg-[#0a0a0a]' : 'bg-[#121a27]'}`}
                  >
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            {pendingRequests.map(req => (
              <div
                key={req.id}
                className="bg-[#0a0a0a] border border-[#222222] rounded-sm p-4 space-y-3"
              >
                ...
                {req.reason && (
                  <p className="text-xs text-rmpg-300 bg-[#050505] border border-[#222222] rounded-sm p-2">
                    {req.reason}
                  </p>
                )}
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 bg-[#050505] border border-[#222222] text-white text-xs px-2 py-1.5 rounded-sm focus:outline-none focus:border-brand-500"
                  />
                  <button type="button"
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <select
            ...
            className="bg-[#050505] border border-[#222222] text-white text-xs px-2 py-1.5 rounded-sm focus:outline-none focus:border-brand-500"
          >
