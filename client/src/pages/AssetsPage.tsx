          ...
          <div className="bg-surface-raised border border-rmpg-700 p-6 max-w-lg w-full" style={{ borderRadius: 2 }} onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div><label htmlFor="ff-assetspage-0" className="text-[10px] text-rmpg-400 uppercase font-semibold">Asset Tag <span className="text-red-500">*</span></label>
                ...
                <div><label htmlFor="ff-assetspage-1" className="text-[10px] text-rmpg-400 uppercase font-semibold">Type</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div><label htmlFor="ff-assetspage-2" className="text-[10px] text-rmpg-400 uppercase font-semibold">Make</label><input id="ff-assetspage-2" className="input-dark mt-1" value={formData.make || ''} onChange={e => setFormData({...formData, make: e.target.value})} /></div>
                <div><label htmlFor="ff-assetspage-3" className="text-[10px] text-rmpg-400 uppercase font-semibold">Model</label><input id="ff-assetspage-3" className="input-dark mt-1" value={formData.model || ''} onChange={e => setFormData({...formData, model: e.target.value})} /></div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div><label htmlFor="ff-assetspage-4" className="text-[10px] text-rmpg-400 uppercase font-semibold">Serial #</label><input id="ff-assetspage-4" className="input-dark mt-1" value={formData.serial_number || ''} onChange={e => setFormData({...formData, serial_number: e.target.value})} /></div>
                <div><label htmlFor="ff-assetspage-5" className="text-[10px] text-rmpg-400 uppercase font-semibold">Status</label>
