        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70" onClick={() => setEditingRecord(null)}>
          <div className="bg-surface-raised border border-rmpg-700 p-6 max-w-lg w-full" style={{ borderRadius: 2 }} onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              <div><label htmlFor="ff-riskpage-0" className="text-[10px] text-rmpg-400 uppercase font-semibold">Entity Type <span className="text-red-500">*</span></label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div><label htmlFor="ff-riskpage-1" className="text-[10px] text-rmpg-400 uppercase font-semibold">Risk Level</label>
                ...
                <div><label htmlFor="ff-riskpage-2" className="text-[10px] text-rmpg-400 uppercase font-semibold">Category</label>
              ...
              <div><label htmlFor="ff-riskpage-3" className="text-[10px] text-rmpg-400 uppercase font-semibold">Description <span className="text-red-500">*</span></label>
              ...
              <div><label htmlFor="ff-riskpage-4" className="text-[10px] text-rmpg-400 uppercase font-semibold">Mitigation Plan</label>
