      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <div className="relative flex-1">
          <input id="ff-quicksearchcard-0"
            ...
            className="w-full h-11 bg-[#050505] border border-[#222] text-rmpg-100 text-base px-3 placeholder:text-gray-600"
          />
          {loading && (
            <span
            ...
            <div key={type}>
              {groups[type].map((r, idx) => (
                <button
                  ...
                  className="py-2 border-b border-[#1a1a1a] text-rmpg-100 text-xs w-full text-left flex items-center"
                >
