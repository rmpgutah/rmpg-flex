  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-3">
      ...
      <div className="grid grid-cols-5 gap-2">
        ...
        }`} style={{ background: getExpiryStatus(detail.next_service_due) === 'expired' ? '#1a1400' : '#161616' }}>
      ...
      {detail.notes && (
        <div className="panel-beveled p-3 bg-surface-base">
          ...
          <div className="p-2 text-[11px] text-rmpg-300 whitespace-pre-wrap leading-relaxed" style={{ background: '#161616', border: '1px solid #1e3048' }}>
            {detail.notes}
          </div>
        </div>
      )}
      ...
      <div className="panel-beveled p-3 bg-surface-base">
        ...
        {maintenance.length === 0 ? (
          <div className="text-center py-6">
            <div className="w-12 h-12 mx-auto mb-2 rounded-full border border-rmpg-700 flex items-center justify-center" style={{ background: '#161616' }}>
