          ...
          {maintenance_cost_trend.length > 0 ? (
            <ResponsiveContainer width="100%" height={180}>
              <LineChart data={maintenance_cost_trend}>
                ...
                <XAxis dataKey="month" tick={{ fill: '#4a6280', fontSize: 9 }} tickLine={false} axisLine={{ stroke: '#2a3e58' }} />
                <YAxis tick={{ fill: '#4a6280', fontSize: 9 }} tickLine={false} axisLine={{ stroke: '#2a3e58' }}
                  tickFormatter={(v) => `$${v}`} />
          ...
          {mileage_distribution.some(d => d.count > 0) ? (
            <ResponsiveContainer width="100%" height={180}>
              <BarChart data={mileage_distribution}>
                <CartesianGrid strokeDasharray="3 3" stroke="#1e3048" />
                <XAxis dataKey="range" tick={{ fill: '#4a6280', fontSize: 9 }} tickLine={false} axisLine={{ stroke: '#2a3e58' }} />
                <YAxis tick={{ fill: '#4a6280', fontSize: 9 }} tickLine={false} axisLine={{ stroke: '#2a3e58' }} />
