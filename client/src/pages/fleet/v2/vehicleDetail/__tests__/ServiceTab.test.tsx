...
beforeEach(() => {
  ...
  vi.stubGlobal('fetch', vi.fn().mockImplementation(() => Promise.resolve(new Response(JSON.stringify([
    { id: 1, type: 'Oil Change', performed_at: '2026-06-15', cost: 89.99, vendor: 'Jiffy Lube', mileage_at_service: 47000, notes: null },
    { id: 2, type: 'Brake Pads', performed_at: '2026-05-10', cost: 425.50, vendor: 'Big O Tires', mileage_at_service: 45500, notes: null },
  ]), { status: 200 }))));
});
