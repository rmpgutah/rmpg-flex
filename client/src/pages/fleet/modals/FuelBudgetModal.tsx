      ...
      <div className="panel-beveled w-[480px] max-w-full mx-4 max-h-[90vh] flex flex-col bg-surface-raised"
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="ff-fuelbudgetmodal-0" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Period</label>
            ...
            <div>
              <label htmlFor="ff-fuelbudgetmodal-1" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Budget Amount ($)</label>
            ...
            <div>
              <label htmlFor="ff-fuelbudgetmodal-2" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Alert Threshold (%)</label>
            ...
            <div>
              <label htmlFor="ff-fuelbudgetmodal-3" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5 flex items-center gap-1">
            ...
            <div className="col-span-2">
              <label htmlFor="ff-fuelbudgetmodal-4" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5 flex items-center gap-1">
          ...
          <div>
            <label htmlFor="ff-fuelbudgetmodal-5" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Notes</label>
