      ...
      <div className="panel-beveled w-[560px] max-w-full mx-4 max-h-[80vh] flex flex-col bg-surface-raised" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              <label htmlFor="ff-vehicleformmodal-2" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Make</label>
              <input id="ff-vehicleformmodal-2" className="input-dark w-full text-[11px] min-h-[36px]" value={form.make}
                onChange={(e) => setField('make', e.target.value)} />
            </div>
            <div>
              <label htmlFor="ff-vehicleformmodal-3" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Model</label>
              <input id="ff-vehicleformmodal-3" className="input-dark w-full text-[11px] min-h-[36px]" value={form.model}
                onChange={(e) => setField('model', e.target.value)} />
            </div>
            <div>
              <label htmlFor="ff-vehicleformmodal-4" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Year</label>
            ...
            <div>
              <label htmlFor="ff-vehicleformmodal-5" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Color</label>
              <input id="ff-vehicleformmodal-5" className="input-dark w-full text-[11px] min-h-[36px]" value={form.color}
                onChange={(e) => setField('color', e.target.value)} />
            </div>
            <div className="col-span-2">
              <label htmlFor="ff-vehicleformmodal-6" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">VIN</label>
            ...
            <div>
              <label htmlFor="ff-vehicleformmodal-7" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Plate Number</label>
            ...
            <div>
              <label htmlFor="ff-vehicleformmodal-8" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Plate State</label>
            ...
            <div>
              <label htmlFor="ff-vehicleformmodal-9" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Current Mileage</label>
            ...
            <div>
              <label htmlFor="ff-vehicleformmodal-10" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Next Service Mileage</label>
            ...
            <div>
              <label htmlFor="ff-vehicleformmodal-11" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Registration Expiry (Date/Time)</label>
            ...
            <div>
              <label htmlFor="ff-vehicleformmodal-12" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Insurance Expiry (Date/Time)</label>
            ...
            <div />
            <div className="col-span-2">
              <label htmlFor="ff-vehicleformmodal-13" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Equipment (comma-separated)</label>
            ...
            <div className="col-span-2">
              <label htmlFor="ff-vehicleformmodal-14" className="text-[9px] text-rmpg-500 uppercase font-semibold block mb-0.5">Notes</label>
