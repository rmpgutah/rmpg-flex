  ...
  return (
    <div className="h-full flex flex-col bg-surface-base text-white overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* ── LEFT: Plan List ── */}
        <div className="w-1/3 flex flex-col border-r border-rmpg-700/50 overflow-hidden">
          <div className="text-[9px] text-rmpg-500 uppercase font-bold tracking-wider px-3 py-2" style={{ background: '#111', borderBottom: '1px solid #222' }}>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderLeft: `3px solid ${shiftConfig?.color || '#666'}`,
                    }}
                  >
              ...
              <div className="flex-1 overflow-auto">
                ...
                {sp.activePlan.assignments.length === 0 ? (
                  ...
                  <table className="w-full text-[10px]">
                    <thead>
                      <tr style={{ background: '#111' }} className="text-rmpg-500 text-[9px] uppercase tracking-wider">
                ...
                {/* Summary panel */}
                {sp.activePlan.assignments.length > 0 && (
                  <div className="px-4 py-3" style={{ background: '#0c0c0c', borderTop: '1px solid #222' }}>
                    <div className="text-[9px] text-rmpg-500 uppercase font-bold tracking-wider mb-2">Coverage Summary</div>
                    <div className="grid grid-cols-4 gap-4">
                      <div className="p-2" style={{ background: '#111', border: '1px solid #222' }}>
