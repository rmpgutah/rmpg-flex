...
export function mapDbVehicle(row: Record<string, unknown>): Vehicle {
  ...
  return {
    ...
    // Extended fields — server stores but mapper was missing
    ...
    owner_name_raw: row.owner_name ? String(row.owner_name) : undefined,
    primary_driver_name: row.primary_driver_name ? String(row.primary_driver_name) : undefined,
    registered_owner: row.registered_owner ? String(row.registered_owner) : undefined,
