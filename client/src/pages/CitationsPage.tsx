...
export default function CitationsPage() {
  ...
  const renderListPanel = () => (
    <>
      ...
      {/* List body */}
      <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-[#2b313a] scrollbar-track-transparent" style={{ overscrollBehavior: 'contain' }}>
        {loading ? (
            ...
            <section>
              ...
              <div className="bg-surface-raised border border-rmpg-700 p-3 space-y-1.5 text-xs">
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  ...
                  {(c as any).is_equipment_violation ? <span className="text-[8px] font-bold text-gray-400 bg-[#0c0f13]/30 px-1.5 py-0.5 border border-gray-700/30">EQUIPMENT VIOLATION</span> : null}
                </div>
              </div>
            </section>
          )}
  ...
  const renderForm = () => (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {/* Scrollable body */}
      <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-[#2b313a] scrollbar-track-transparent p-4 space-y-5">
        {saveError && (
          ...
          <div className="space-y-3">
            <div ref={personDropdownRef} className="relative">
              ...
              {showPersonDropdown && personResults.length > 0 && (
                <div className="absolute z-50 mt-1 w-full bg-rmpg-800 border border-rmpg-600 shadow-xl max-h-48 overflow-y-auto scrollbar-thin scrollbar-thumb-[#2b313a] scrollbar-track-transparent">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div>
                ...
                <select className="w-full bg-[#1b2128] border border-[#2a3a4a] rounded-sm px-2 py-1.5 text-sm text-white"
