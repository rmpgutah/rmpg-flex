...
export default function AnalyticsTab({ analytics, loading }: Props) {
  ...
  const headcountCards: { label: string; value: string | number; icon: React.ElementType; color: string; topBorder: string }[] = [
    ...
    { label: 'Clocked In', value: hc.clocked_in, icon: Clock, color: 'text-rmpg-400', topBorder: 'border-t-gray-500' },
    ...
    { label: 'New Hires (30d)', value: hc.new_hires_30d, icon: UserPlus, color: 'text-rmpg-400', topBorder: 'border-t-gray-500' },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="panel-beveled p-4 bg-surface-base">
          ...
          <div className="flex flex-col items-center py-4">
            <div className="relative w-28 h-28">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-xl font-bold font-mono text-rmpg-100">{(Number(complianceRate) || 0).toFixed(0)}%</span>
          ...
          <div className="space-y-2 mt-2">
            <div className="w-full h-2 rounded-full overflow-hidden flex" style={{ background: 'var(--border-subtle)' }}>
