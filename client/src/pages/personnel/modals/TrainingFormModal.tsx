  ...
  return (
    ...
    >
      ...
      <div className="panel-inset p-3 space-y-3">
        <div>
          <label htmlFor="ff-trainingformmodal-0" className="field-label">Officer <span className="text-red-400">*</span></label>
        ...
        <div>
          <label htmlFor="ff-trainingformmodal-1" className="field-label">Course Name <span className="text-red-400">*</span></label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label htmlFor="ff-trainingformmodal-2" className="field-label">Category</label>
          ...
          <div>
            <label htmlFor="ff-trainingformmodal-3" className="field-label">Status</label>
      ...
      <div className="panel-inset p-3 space-y-3">
        <div>
          <label htmlFor="ff-trainingformmodal-4" className="field-label">Provider</label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label htmlFor="ff-trainingformmodal-5" className="field-label">Completed Date</label>
          ...
          <div>
            <label htmlFor="ff-trainingformmodal-6" className="field-label">Expiry Date</label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div>
            <label htmlFor="ff-trainingformmodal-7" className="field-label">Hours</label>
          ...
          <div>
            <label htmlFor="ff-trainingformmodal-8" className="field-label">Score (%)</label>
          ...
          <div>
            <label htmlFor="ff-trainingformmodal-9" className="field-label">Certificate #</label>
