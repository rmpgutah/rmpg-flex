...
export const ROLE_COLORS: Record<string, string> = {
  ...
  dispatcher: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
};

export const ACTION_COLORS: Record<string, string> = {
  clock_in: 'text-green-400',
  clock_out: 'text-amber-400',
  user_login: 'text-rmpg-400',
...
export const TRAINING_CATEGORY_COLORS: Record<string, string> = {
  ...
  communication: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
  driving: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
  technology: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
...
export const DEPLOYMENT_STATUS_COLORS: Record<string, string> = {
  ...
  scheduled: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
...
export const EQUIPMENT_STATUS_COLORS: Record<string, string> = {
  ...
  maintenance: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
};
...
export const CAMERA_STATUS_COLORS: Record<string, string> = {
  ...
  assigned: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
...
export const DASHCAM_EVENT_COLORS: Record<string, string> = {
  ...
  camera_triggered: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
  video_recorded: 'bg-surface-sunken/50 text-rmpg-400 border border-border-default/50',
};
