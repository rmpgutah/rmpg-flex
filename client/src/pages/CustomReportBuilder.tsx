...
export default function CustomReportBuilder() {
  ...
  return (
    <div className="h-full flex flex-col bg-surface-base text-white overflow-hidden">
      ...
      {/* Step indicators */}
      <div className={`flex items-center ${isMobile ? 'px-2 py-1.5 overflow-x-auto' : 'px-4 py-2'} border-b border-rmpg-700/50 flex-shrink-0 tab-scroll`} style={{ background: '#080808' }}>
        {steps.map((s, i) => (
