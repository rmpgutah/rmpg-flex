...
export default function CourtRecordsPage() {
  ...
  return (
    <div className="app-grid-bg h-full flex flex-col overflow-hidden">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative flex-1 min-w-[180px] max-w-[280px]">
            ...
            <input
              ...
              className="w-full pl-7 pr-2 py-1 bg-[#0c0f13] border border-[#2b313a] text-[10px] text-white placeholder-rmpg-500 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue/30 focus:outline-none"
            />
          </div>
          ...
          <select
            ...
            className="bg-[#0c0f13] border border-[#2b313a] text-[10px] text-white px-2 py-1 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue/30 focus:outline-none"
          >
      ...
      {/* ── Table ── */}
      <div className="flex-1 overflow-auto scrollbar-thin scrollbar-thumb-[#2b313a] scrollbar-track-transparent mx-2 mt-2 mb-2 card-glass">
        {loading ? (
          ...
          <>
            {/* Table header */}
            <div className="sticky top-0 z-10 grid grid-cols-[100px_1fr_110px_130px_120px_90px_1fr] gap-px bg-[#0c0f13] border-b border-[#2b313a] text-[9px] font-bold text-rmpg-400 uppercase tracking-widest">
              <div className="px-2 py-1.5 bg-[#161b21]">Event #</div>
              <div className="px-2 py-1.5 bg-[#161b21]">Defendant</div>
              <div className="px-2 py-1.5 bg-[#161b21]">Court Date</div>
              <div className="px-2 py-1.5 bg-[#161b21]">Event Type</div>
              <div className="px-2 py-1.5 bg-[#161b21]">Judge</div>
              <div className="px-2 py-1.5 bg-[#161b21]">Status</div>
              <div className="px-2 py-1.5 bg-[#161b21]">Court / Case #</div>
            </div>
              ...
              return (
                <React.Fragment key={ev.id}>
                  ...
                  <div
                    ...
                    className={`grid grid-cols-[100px_1fr_110px_130px_120px_90px_1fr] gap-px cursor-pointer transition-colors border-b border-[#2b313a]/50 ${
                      isExpanded ? 'bg-[#1b2128]' : 'bg-[#161b21] hover:bg-[#1b2128]/60'
                    }`}
                  >
                  ...
                  {/* Expanded Detail */}
                  {isExpanded && (
                    <div className="bg-[#0c0f13] border-b border-[#2b313a] px-4 py-3 animate-fadeIn">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          {/* Outcome section */}
                          {ev.outcome && (
                            <div className="mt-3 pt-2 border-t border-[#2b313a]">
                        ...
                        <div className="space-y-2">
                          ...
                          {ev.notes ? (
                            <p className="text-[10px] text-rmpg-300 bg-[#161b21] border border-[#2b313a] p-2 whitespace-pre-wrap max-h-32 overflow-auto scrollbar-thin scrollbar-thumb-[#2b313a] scrollbar-track-transparent">
                              {ev.notes}
                            </p>
                          ) : (
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 print:hidden flex items-center justify-center bg-black/60 backdrop-blur-sm" role="dialog" aria-modal="true" onClick={() => setShowCreateModal(false)}>
          <div
            className="bg-[#161b21] border border-[#2b313a] w-full max-w-lg mx-4 shadow-md animate-fadeIn"
          ...
          >
            ...
            <div className="p-4 space-y-3 max-h-[70vh] overflow-auto scrollbar-thin scrollbar-thumb-[#2b313a] scrollbar-track-transparent">
              {/* Event type + date */}
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#0c0f13] border border-[#2b313a] text-[10px] text-white px-2 py-1.5 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue/30 focus:outline-none"
                  >
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0c0f13] border border-[#2b313a] text-[10px] text-white px-2 py-1.5 placeholder-rmpg-500 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue/30 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#0c0f13] border border-[#2b313a] text-[10px] text-white px-2 py-1.5 placeholder-rmpg-500 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue/30 focus:outline-none resize-none"
                />
              </div>

              {/* Buttons */}
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-[#2b313a]">
      ...
      {showOutcomeModal !== null && (
        <div className="fixed inset-0 z-50 print:hidden flex items-center justify-center bg-black/60 backdrop-blur-sm" role="dialog" aria-modal="true" onClick={() => setShowOutcomeModal(null)}>
          <div
            className="bg-[#161b21] border border-[#2b313a] w-full max-w-md mx-4 shadow-md animate-fadeIn"
            onClick={e => e.stopPropagation()}
          >
