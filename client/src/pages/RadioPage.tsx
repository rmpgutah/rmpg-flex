            ...
            <div className="grid grid-cols-2 gap-3">
              {RADIO_CHANNELS.map((ch) => (
                <button
                  ...
                  style={{
                    background: 'linear-gradient(180deg, #162236 0%, #1a2636 100%)',
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.background = 'linear-gradient(180deg, #162236 0%, #1a2636 100%)';
                  }}
                >
              ...
              <button
                ...
                style={{
                  ...
                  background: isInCall
                    ...
                    : !micSupported
                      ? 'radial-gradient(circle, #3a3a3a 0%, #2a3e58 70%, #141e2b 100%)'
                      : isTransmitting
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  {isInCall ? (
                    ...
                    <MicOff style={{ width: 32, height: 32, color: '#4a6280' }} />
                  ) : isTransmitting ? (
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <Users style={{ width: 12, height: 12, color: '#4a6280' }} />
