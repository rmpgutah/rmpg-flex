...
import {
  Users, Shield, Database, Activity, AlertTriangle, CheckCircle, Clock, Wifi,
  BarChart3, TrendingUp, FileText, Car, Building2, Package, Briefcase, Gavel,
  Radio, Zap, Eye, RefreshCw, Loader2,
} from 'lucide-react';
    ...
    <div className="p-4 space-y-4 max-w-7xl">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-2">
          <StatCard icon={Users} label="Individuals" value={data.totalPersons} color="text-brand-400" />
