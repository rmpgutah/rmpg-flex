...
export default function AdminRadioTab() {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Search */}
      <div className="bg-surface-base border border-border-default rounded-sm p-2 flex items-center gap-2">
      ...
      {/* List */}
      <div className="bg-surface-base border border-border-default rounded-sm overflow-hidden">
        {loading ? (
              ...
              {sorted.map(ch => {
                ...
                return (
                  <tr
                    ...
                    className={`border-b border-border-default/50 hover:bg-surface-sunken ${isArchived ? 'opacity-50' : ''}`}
                  >
        ...
        >
          ...
          >
            <div className="border-b border-border-default px-3 py-2 flex items-center justify-between">
              <h3 className="text-xs font-bold uppercase text-rmpg-200 tracking-wide">
                  ...
                  <div className="flex gap-1 mt-1">
                    {COLOR_SWATCHES.map(c => (
                      <button
                        ...
                        className={`w-4 h-4 rounded-sm border ${form.color === c ? 'border-white' : 'border-rmpg-700'}`}
            ...
            <div className="border-t border-border-default px-3 py-2 flex items-center justify-end gap-2">
              <button
                onClick={closeForm}
                disabled={submitting}
                className="text-xs text-rmpg-400 hover:text-rmpg-200 px-2 py-1 disabled:opacity-50"
              >
                Cancel
              </button>
              <button
