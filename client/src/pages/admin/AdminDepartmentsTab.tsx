...
export default function AdminDepartmentsTab({ users, LoadingSpinner, error, setError }: Props) {
  ...
  return (
    <div className="p-4 space-y-3">
      ...
      {/* Form Modal */}
      {showForm && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-start justify-center z-50 animate-fade-in overflow-y-auto p-4" onClick={() => setShowForm(false)} role="dialog" aria-modal="true" aria-label={editing ? 'Edit department' : 'New department'}>
          <div className="bg-surface-base panel-beveled w-full max-w-md mx-4 my-auto" onClick={(e) => e.stopPropagation()}>
