    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          {/* Response Style */}
          <div className="bg-[#141414] border border-[#1a3550] rounded p-4 space-y-3">
          ...
          <div className="bg-[#141414] border border-[#1a3550] rounded p-4 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3 py-1.5 bg-[#0c0c0c] border border-[#1a3550] rounded text-white text-xs focus:outline-none focus:border-blue-500"
              />
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-10 h-5 rounded-full transition-colors ${
                    config.autoRetry ? 'bg-blue-600' : 'bg-[#1a3550]'
                  }`}
                >
              ...
              {config.autoRetry && (
                <div className="space-y-1 pl-4 border-l-2 border-[#1a3550]">
...
function RadioOption({ name, value, selected, label, description, onChange }: {
  ...
  return (
    <label className={`flex items-start gap-3 p-3 rounded border cursor-pointer transition-colors ${
      selected === value ? 'border-blue-500 bg-blue-500/10' : 'border-[#1a3550] hover:border-[#2a4560]'
    }`}>
      <input
        type="radio"
        name={name}
