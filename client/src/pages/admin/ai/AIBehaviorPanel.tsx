    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          {/* Response Style */}
          <div className="bg-[#0a0a0a] border border-[#222222] rounded p-4 space-y-3">
          ...
          <div className="bg-[#0a0a0a] border border-[#222222] rounded p-4 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3 py-1.5 bg-[#050505] border border-[#222222] rounded text-white text-xs focus:outline-none focus:border-gray-500"
              />
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-10 h-5 rounded-full transition-colors ${
                    config.autoRetry ? 'bg-gray-600' : 'bg-[#222222]'
                  }`}
                >
              ...
              {config.autoRetry && (
                <div className="space-y-1 pl-4 border-l-2 border-[#222222]">
...
function RadioOption({ name, value, selected, label, description, onChange }: {
  ...
  return (
    <label className={`flex items-start gap-3 p-3 rounded border cursor-pointer transition-colors ${
      selected === value ? 'border-gray-500 bg-gray-500/10' : 'border-[#222222] hover:border-[#2e2e2e]'
    }`}>
      <input
        type="radio"
        name={name}
