          ...
          {isStreaming && (
            <div className="flex gap-3 justify-start">
              ...
              <div className="max-w-[80%]">
                ...
                {streamingContent ? (
                  <div className="bg-[#1a2636] text-gray-200 rounded-sm px-3 py-2 border border-gray-500/30">
                  ...
                  <div className="bg-[#1a2636] rounded-sm border border-gray-500/30 overflow-hidden">
        ...
        {showFileInput && (
          <div className="px-4 py-2 border-t border-[#1a3550] bg-[#141e2b] flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 bg-[#0d1520] border border-[#1a3550] text-white text-xs px-2 py-1.5 rounded focus:outline-none focus:border-gray-500"
            />
            <button
              onClick={() => {
                setShowFileInput(false);
        ...
        <div className="p-3 border-t border-[#1a3550] bg-[#141e2b]">
          <div className="flex items-end gap-2">
            ...
            <textarea
              ...
              rows={1}
              className="flex-1 bg-[#0d1520] border border-[#1a3550] text-white text-sm px-3 py-2 rounded resize-none focus:outline-none focus:border-gray-500 max-h-32"
            ...
            <button
              ...
              className="p-2 bg-gray-600 hover:bg-gray-700 disabled:bg-[#1a2636] disabled:text-gray-500 text-white rounded transition-colors"
            >
