...
const CACHE_NAME = 'rmpg-flex-v154';
        ...
        .catch(() =>
          caches.match(event.request)
            ...
            .then((fallback) => fallback || new Response(
              '<!DOCTYPE html><html><body style="background:#141414;color:#e5e7eb;font-family:sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;margin:0"><div style="text-align:center"><h1>Offline</h1><p>No network connection. Please reconnect and try again.</p></div></body></html>',
