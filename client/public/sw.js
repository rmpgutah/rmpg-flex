...
// v1217: Plate Log — ConfirmDialog gates scan-tile dismiss (admin|manager DISMISS button + Esc cascade); ?capture_id= deep-link toasts success/error + scrollIntoView on scanTileRef; ?plate= deep-link already present; Esc cascade adds e.stopPropagation() per branch + confirmDismissScan+confirmBulk in full deps; canDelete (admin|manager) gates DISMISS; useToast imported; scanTileRef for scroll target.
