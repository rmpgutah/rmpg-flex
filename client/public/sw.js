...
// v998: Records form draft fix — useFormDraft clearDraft() now gates the
//       unmount auto-save (clearedRef); all form modals call clearDraft()
//       before delegating to onSubmit so stale drafts are never restored
//       after a successful save. Also fixes PersonFormModal double-trigger:
//       openEditPerson now fetches full data before opening the modal.
