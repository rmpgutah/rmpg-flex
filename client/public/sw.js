...
// v1223: Reset Password — useSearchParams token deep-link (strip after consume+useRef guard), N focuses password field, Esc clears error (stopPropagation), background/button/label/icon hex → CSS var tokens, inline onMouseEnter/Leave → Tailwind hover tokens, err: any → unknown.
