...
// v1222: Reports — ConfirmDialog gates Approve; ?type=/?card= deep-link (scroll+toast+useRef guard+strip); N+canCreate (admin|manager) opens builder; Esc cascade (error→custom-range) stopPropagation full deps; canApprove (admin|manager|supervisor) gates Approve button+menu item; dead convertToCSV removed; PIE/PRIORITY/chart hex → CSS var tokens; ?type= alias for ?card= param.
