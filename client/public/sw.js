...
// v1224: Risk — ?assessment_id= deep-link (scroll+flash+toast+useRef guard), ?subject_id= filters list by entity_id; ConfirmDialog gates delete; N+canWrite (admin|manager) role gate; Esc cascade (deleteId->showForm) stopPropagation; loading/no-data/no-results distinct empty states; .data envelope unwrapped; entity_id added to interface+filter; no raw hex.
