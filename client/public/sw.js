...
// v1220: Records — ?record_id=+?type= deep-link aliases added+stripped; N shortcut gated to admin|manager; Esc cascade e.stopPropagation() per branch + closeSelection in deps; New buttons (all 5 tabs) + SpillmanMenuBar onNew gated to isAdminOrManager; per-tab loading spinner (persons|vehicles|properties|businesses|evidence each distinct); dead isLoading removed.
