...
// v1215: Person Intel Dossier — ConfirmDialog gates delete (canDelete admin|manager); ?person_id= deep-link (useRef guard+toast+strip); N navigates to new investigation; Esc cascade (deleteConfirmOpen→navigate back) stopPropagation; 4-state empty (loading/pending/no-results/error); canDelete gates Trash2 button; parseTimestamp replaces new Date(); sources tab empty state added.
