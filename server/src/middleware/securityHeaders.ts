...
export function securityHeaders(req: Request, res: Response, next: NextFunction): void {
  ...
  res.set('Content-Security-Policy', [
    ...
    "connect-src 'self' wss://rmpgutah.us ws://localhost:* wss://localhost:* https://*.googleapis.com https://*.google.com https://*.gstatic.com https://*.arcgis.com https://js.arcgis.com https://*.arcgisonline.com https://warrants.utah.gov",
