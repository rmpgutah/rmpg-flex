...
export const ROUTE_REGISTRY: RouteMount[] = [
  ...
  { prefix: '/api/admin/daily-email', router: dailyEmailAdmin, auth: 'public',
    note: 'Daily email report recipient management: GET/PUT /recipients, POST /test-send. Admin-only (auth handled per-route).' },
