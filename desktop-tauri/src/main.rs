...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::kiosk::set_kiosk_shell,
            commands::kiosk::get_kiosk_shell_state,
            commands::gps::detect_internal_gps,
            commands::gps::start_internal_gps,
            commands::gps::stop_internal_gps,
            commands::gps::list_serial_ports,
            commands::recon::check_recon_connect,
            commands::recon::launch_recon_connect,
            commands::recon::install_recon_connect,
            commands::recon::recon_spawn,
            commands::recon::recon_input,
            commands::recon::recon_kill,
            commands::recon::recon_kill_all,
            commands::recon::recon_install_state,
            commands::recon::recon_update,
            commands::offline::get_offline_state,
            commands::offline::get_sync_status,
            commands::offline::enter_pin,
            commands::offline::generate_pin,
            commands::offline::store_auth_session,
            commands::offline::get_cached_user,
            commands::offline::trigger_sync,
            commands::offline::pause_sync,
            commands::offline::resume_sync,
            commands::offline::get_sync_queue_detail,
            commands::offline::get_offline_write_queue_size,
            commands::offline::retry_failed_sync_item,
            commands::offline::clear_failed_sync_items,
            commands::offline::get_last_sync_error,
            commands::offline::get_local_cache_stats,
            commands::offline::clear_local_cache,
            commands::offline::force_full_resync,
            commands::offline::local_api,
        ])
        .setup(|app| {
