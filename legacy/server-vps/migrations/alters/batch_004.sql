...
ALTER TABLE vehicles_records ADD COLUMN commercial_vehicle INTEGER  0;
ALTER TABLE vehicles_records ADD COLUMN hazmat INTEGER  0;
...
ALTER TABLE vehicles_records ADD COLUMN is_stolen INTEGER  0;
ALTER TABLE vehicles_records ADD COLUMN tow_status TEXT;
ALTER TABLE vehicles_records ADD COLUMN tow_company TEXT;
