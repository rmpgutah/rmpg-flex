...
describe('renderDailyEmailHtml', () => {
  ...
  it('escapes HTML in user data', () => {
    const xssBlotter: DailyReportData = {
      ...
      operations: {
        calls: [{
          call_number: '<script>alert("xss")</script>', received_at: null, created_at: '',
          incident_type: null, priority: null, location_address: null,
          disposition: null, status: null, unit_call_signs: null,
          responding_officer: null, description: null, notes: null, source: null,
          dispatch_code: null, sector_name: null, zone_name: null, beat_name: null,
          weapons_involved: null, domestic_violence: null, mental_health_crisis: null,
          juvenile_involved: null, felony_in_progress: null, officer_safety_caution: null,
          k9_requested: null, ems_requested: null, response_time_seconds: null,
          onscene_duration_seconds: null, pso_requestor_name: null, pso_service_type: null,
